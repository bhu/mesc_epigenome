...
inps = ['mESC_Par_Input', 'mESC_DNMT_TKO_input', 'mESC_sgNSD1_Input']
...
for reg in ['Met', 'Unm']:
    ...
    fig = plt.figure(constrained_layout=True,figsize=[7,4.2])
    ...
    plt.savefig('f4_c.%s.%s.%s.pdf' % (reg, nrm, kind), transparent=True,dpi=600)
    plt.close()
